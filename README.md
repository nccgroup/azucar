...
Azucar is a multi-threaded plugin-based tool to help assess the security of your Azure Cloud environment subscription. By leveraging the Azure API, Azucar automatically gathers and analyses a variety of configuration data relating to a particular subscription to determine security risks.
...
Although there is already support for a variety of file formats (CSV, XML or JSON), there is also support for exporting data to Microsoft Office Excel 2010/2013/2016. Currently, it supports style modification, chart creation, company logo or independent language support.
