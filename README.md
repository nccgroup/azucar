...
Azucar works straight out of the box with PowerShell version 3.x and .NET 4.5. To  check your Windows PowerShell version, open a console and run the command <b>$PsVersionTable:</b>
