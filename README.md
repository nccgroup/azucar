...
Although there is already support for a variety of file formats (CSV, XML or JSON), you could also export your data to Excel v. 2010/2013/2016. At the time of writing, the tool supports style modification, chart creation, company logo or independent language support.
