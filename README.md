...
You should use an account with at least **read-permission** on the assets you want to access. Mmore information about Role-Based Access Control in Azure can be found by clicking [here](https://docs.microsoft.com/en-us/azure/role-based-access-control/role-assignments-portal).
